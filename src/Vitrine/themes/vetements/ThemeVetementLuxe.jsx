...
export default function ThemeVetementLuxe({ siteData, products, isEditable, onEditProduct }) {
  ...
  return (
    <div className="theme-vetement-luxe">
      ...
      <section id="home" className="l-hero">
        ...
        <div className="l-hero-inner reveal">
          <span className="l-gold-text hero-tag">MAISON DE HAUTE COUTURE</span>
          <h1>
        ...
        <div className="about-grid">
          <div className="about-img-box">
            ...
            <div className="about-overlay">
              <h3>SAVOIR-FAIRE</h3>
              <p>Une exigence de chaque instant pour des pièces uniques et d'exception.</p>
            </div>
          </div>
          <div className="about-text reveal">
            <h2>L'Art de <br />S'habiller</h2>
            <p>
