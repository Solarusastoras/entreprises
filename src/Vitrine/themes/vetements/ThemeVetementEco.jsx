...
import { Shirt, Map, Compass, MapPin } from 'lucide-react';
import FavoriteButton from '../../components/common/FavoriteButton';

export default function ThemeVetementEco({ siteData, products }) {
   ...
   return (
      <div className="theme-vetement-eco">
         ...
         <section className="eco-hero-section">
            ...
            <div>
               <h1>Matières naturelles<br />{siteData.nomEntreprise}</h1>
         ...
         <section id="about" className="eco-about-section">
            <div className="about-content">
               <Shirt size={40} className="eco-icon" />
               <h2>La mode éthique</h2>
               <p>
         ...
         <section id="products" className="eco-products-section">
            <div className="section-header">
               ...
               <p>Coupé avec soin, cousu avec passion.</p>
            </div>
            ...
            <div className="contact-card">
               <div>
                  <div className="title-box">
                     <Shirt size={24} style={{ color: 'var(--eco-primary)' }} />
         ...
         <footer>
            ...
            <p>Tissus locaux • Coton bio • Style intemporel • 2026</p>
         </footer>
      </div>
   );
}
