...
export default function ThemeBoulangerieModerne({ siteData, products }) {
   ...
   return (
      <div className="theme-boulangerie-moderne">
         ...
         <section id="products" className="moderne-products-section">
            <div className="section-header m-slide">
               <div className="header-title">
                  ...
                  <h2>BAKERY <span className="m-accent-blue">FRESH</span></h2>
               </div>
