...
export default function Formulaire() {
  ...
  // 🔥 Sécurisation de l’ID (corrige id=eq.NaN)
  const modifierIdParam = searchParams.get("modifier");
  const modifierId =
    modifierIdParam && !isNaN(Number(modifierIdParam))
  ...
  const setHoraire = (j, v) =>
    setForm((p) => ({ ...p, horaires: { ...p.horaires, [j]: v } }));

  const setCoord = (c, v) =>
    setForm((p) => ({ ...p, coordonnees: { ...p.coordonnees, [c]: v } }));
  ...
  if (chargement)
    return (
      <div
        style={{ padding: "3rem", textAlign: "center", color: "var(--c-ink3)" }}
      >
        Chargement…
      </div>
    );
      ...
      <div className="header">
        ...
        <p className="sous">
          {estModif
            ...
            : "Ajoutez un commerce sans site web."}
        </p>
      </div>
      {succes && (
        <div className="succes">
          ✅ {estModif ? "Fiche mise à jour !" : "Commerce ajouté !"}{" "}
          Redirection…
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="form" noValidate>
        <fieldset className="fieldset">
          ...
          <div className="row2">
            ...
            <div className="champ">
              <label className="label">
                Secteur <span className="requis">*</span>
              </label>
              <select
          ...
          <div className="row2">
            <div className="champ">
              ...
              <input
                ...
                onChange={(e) => set("contrat_type", e.target.value)}
              />
            </div>
            <div className="champ">
        ...
        <fieldset className="fieldset">
          ...
          <p className="aide">
            Ex : <code>07h00 - 19h30</code> ou <code>Fermé</code>
          </p>
        ...
        <fieldset className="fieldset">
          <legend className="legend">
            GPS <span className="optionnel">(optionnel)</span>
          </legend>
          <p className="aide">
            Coordonnées sur{" "}
            <a
