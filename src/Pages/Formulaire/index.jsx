...
export default function Formulaire() {
    ...
    async function charger() {
      ...
      if (!error && data) {
        setForm({
          ...
          coordonnees: { lat: data.coordonnees?.lat || "", lng: data.coordonnees?.lng || "" },
  ...
  if (chargement) return <div style={{padding:"3rem",textAlign:"center",color:"var(--c-ink3)"}}>Chargement…</div>;
    ...
    <main className="main">
      ...
      <form onSubmit={handleSubmit} className="form" noValidate>
        ...
        <fieldset className="fieldset">
          ...
          <p className="aide">Coordonnées sur <a href="https://www.openstreetmap.org/" target="_blank" rel="noreferrer" className="lienAide">OpenStreetMap</a> (clic droit).</p>
          <div className="row2">
            <div className="champ">
