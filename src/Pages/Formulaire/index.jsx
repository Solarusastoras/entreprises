...
const SECTEURS = [
  ...
  "Mécanicien / Technicien Motocycles",
    ...
    if (modifierId) {
      ...
      if (e)
        setForm({
          ...
          statut_prospection: e.statut_prospection || "prospect",
          statut_site: e.statut_site || "",
          contact_nom: e.contact_nom || "",
          contrat_type: e.contrat_type || "",
          date_contact: e.date_contact || "",
          date_relance: e.date_relance || "",
          note: e.note || "",
        });
    }
